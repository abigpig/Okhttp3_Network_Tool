...
public class HttpUtil {
    ...
    private final static long CONNECT_TIMEOUT = 5 * 60;//超时时间，秒
    private final static long READ_TIMEOUT = 5 * 60;//读取时间，秒
    private final static long WRITE_TIMEOUT = 5 * 60;//写入时间，秒
